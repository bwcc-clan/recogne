...
from typing import Any, Callable, Coroutine, List, Sequence, Tuple, Union

from rcon.info.models import EventModel, EventTypes, PlayerKillEvent, PlayerSuicideEvent
from src.hll_bot.utils import to_timedelta
